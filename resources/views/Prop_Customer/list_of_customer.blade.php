...
<div class="cc_wrapper">
    ...
    <table class=" table nowrap data-table table-responsive display " style="width:100%" cellspacing="0"  id="data_table">
        ...
        @foreach ($Customers as $Customer)
              <tr>
              <td>{{$Customer->id}}</td>
              <td>{{$Customer->prop_Customer_name}}</td>
              <td>{{$Customer->prop_Last_name}}</td>
              <td>{{$Customer->prop_Mobile_Number}}</td>
              <td>{{$Customer->prop_Email_Id}}</td>
              <td>{{$Customer->prop_Requirement_Type}}</td>
              <td>{{$Customer->prop_Requirement_Category}}</td>
              <td>{{$Customer->prop_property_category}}</td>
              <td>{{$Customer->prop_property_type}}</td>
              <td>{{$Customer->prop_Price_Min}}</td>
              <td>{{$Customer->prop_Price_Max}}</td>

               <td>{{$Customer->prop_Area_Min}}</td>
              <td>{{$Customer->prop_Area_Max}}</td>
              <td>{{$Customer->prop_Bath_Max}}</td>
              <td>{{$Customer->prop_Bath_Min}}</td>

              <td>{{$Customer->prop_Location}}</td>
              <td>{{$Customer->prop_Intrested_Property}}</td>
            
              <td>{{$Customer->prop_description}}</td>
