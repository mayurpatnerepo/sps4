                  ...
                  <!-- text input -->
                    ...
                    {{csrf_field()}}
                      <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <input list="prop_related" name="prop_related" placeholder="Related" class="form-control Related">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="row" id="myTooltips">
                          <div class="col-12">
                            <label class="form-label required">Organization Name1</label>
                          </div>
                          <div class="col-9">
                           ...
                           @foreach ($organaization as $organisation)
                            ...
                            <input type="text" id="hidden_orgid" name="hidden_orgid" hidden/>
                            <input type="text" id="contact_person_name" name="contact_person_name" hidden/>
                          </div>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" class="form-control" name="prop_to" id="prop_to" placeholder="To" maxlength="180">
                        </div>
                        
                          
                        <div class="col-6">
                            <label class="form-label required">Address</label>
                            <input type="text" class="form-control" name="prop_address" id="prop_address" placeholder="Address" maxlength="400">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-3">
                        ...
                        <div class="col-3">
                            ...
                            <div class="input-group date" data-provide="datepicker">
                               <input type="text" id="prop_date" name="prop_date" placeholder="Date" class="form-control">
                        ...
                        <div class="col-3">
                            ...
                            <div class="input-group date" data-provide="datepicker">
                               <input type="text" id="prop_opentill" name="prop_opentill" placeholder="Open Till" class="form-control">
                                <div class="input-group-addon">
                                <span class="glyphicon glyphicon-th"></span>
                                </div>
                             </div> 
                    ...
                    <div class="form-group row">
                        <div class="col-3">
                            ...
                            <input list="prop_currency" name="prop_currency" placeholder="Currency" class="form-control product">
                        ...
                        <div class="col-3">
                                ...
                                <input type="text" class="form-control" name="prop_city" id="prop_city" placeholder="City" maxlength="100" onKeyPress="return ValidateAlpha(event);">
                        </div>
                        <div class="col-3">
                                <label class="form-label required">State </label>
                               <input type="text" class="form-control" name="prop_state" id="prop_state" placeholder="State" maxlength="100" onKeyPress="return ValidateAlpha(event);">
                        </div>
                        <div class="col-3">
                            <label class="form-label required">Country</label>
                                <input type="text" class="form-control" name="prop_country" id="prop_country" placeholder="Country" maxlength="100" onKeyPress="return ValidateAlpha(event);">
                        </div>
                    </div>   
                     <div class="form-group row">
                         ...
                         <div class="col-3">
                            ...
                            <input type="text" class="form-control" name="prop_zip" id="prop_zip" placeholder="Zip Code" maxlength="15" onkeypress="return isNumber(event)">
                                
                        </div>
                        <div class="col-3">
                            <label for="prop_email" class="form-label">Email</label>
                            <input type="text" class="form-control" name="prop_email" id="prop_email" onblur="validate_email()" placeholder="Email">
                           
                                
                        </div>
                        <div class="col-3">
                            <label for="prop_phone" class="form-label">Phone </label>
                            <input type="text" class="form-control" name="prop_phone" id="prop_phone" placeholder="Phone Number" maxlength="15" onkeypress="return Validate(event)">
      ...
      <table class="table table-bordered table-hover" id="tab_logic">
        <thead>
          <tr>
            ...
            <th class="text-center"> Dis. Amount </th>
          ...
          <tr>
            ...
            <td>
             {{-- <select name='product[]' class="form-control product">  --}}
              <input list="browsers" name="product[]" id="product" placeholder="Select" class="form-control product" autocomplete="off">
            ...
            {{-- <td><input type="text" name='product[]' id="product" placeholder="Product" class="form-control product"/></td> --}}
            <td><input type="number" name='qty[]' id="qty" placeholder='Qty' class="form-control qty" step="0" min="0"/></td>
            <td>
            <input type="number" name='price[]' id="price" value="" placeholder='Unit Price' class="form-control Price" step="0.00" min="0" >
            </td>
             <td>
            <input type="number" name='discount[]' id="discount" value="" placeholder='Discount' class="form-control discount" step="0.00" min="0">
            </td>
             <td>
            <input type="number" name='discount_amt[]' id="discount_amt" value="" placeholder='Amount' class="form-control discount_amt" step="0.00" min="0" >
            </td>
            <td>
           ...
           <td>
            <input type="number" name='gst_amt[]' id="gst_amt" value="" placeholder='Amount' class="form-control gst_amt" step="0.00" min="0" disabled>
            </td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center"><div class="input-group mb-2 mb-sm-0">
                <input type="number" class="form-control" name="Fr_charges" id="Fr_charges" placeholder="Freight">
    ...
    function addrow(){
      ...
      debugger;
         ...
         var addrow ='<tr id="addr0">'+
            '<td><input type="checkbox"  name="record"></td>'+
            '<td>'+            
                    '<input list="browsers" name="product[]" id="product" placeholder="Select" data-attri_id="" class="form-control product" autocomplete="off">'+
                    '<datalist id="browsers">'+
                    '<option value="0" selected="true" disabled="true">Select Product </option>'+
                    '@foreach ($products as $product )'+
          ...
          $.ajax({
            ...
            {   
                console.log(data);
                  ...
                  swal("Order Created Succesfully","","success");
...
function calc_total()
{
  ...
  $('#total_amount').val(total+Fr_charges);
